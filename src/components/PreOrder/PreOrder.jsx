...
function PreOrder() {
    ...
    if (!isLoading && !isError && !data || data?.data?.length === 0) {
        ...
        let filterData = data?.data?.filter((item)=> item?.isOnMarketStatus === 'pre-order')
        ...
        <>
            <div className='container mx-auto'>
                <div className='text-center mb-5'>
                    <h4 className='text-2xl sm:text-4xl md:text-6xl font-bold extraFont my-5'>Pre-Order Available</h4>
                </div>
