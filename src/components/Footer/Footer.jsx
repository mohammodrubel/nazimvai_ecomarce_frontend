...
export default function Footer() {
  return (
    <div classNameName="text-center mt-20 block bg-red-500">
        <footer className="bg-white">
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div
      className="grid grid-cols-1 gap-8 justify-between mx-auto pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16"
    >
      <div>
