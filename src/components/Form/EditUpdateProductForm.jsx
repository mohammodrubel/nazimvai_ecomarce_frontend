...
import { useUpdateProductMutation } from "@/lib/fetchers/Product/ProductApi";
...
export default function EditUpdateProductForm({ previousData }) {
  ...
  useEffect(() => {
    if (previousData) {
      form.setFieldsValue({
        ...
        total_quantity: previousData.total_quantity,
  ...
  // Define handleRemoveImage outside of useEffect
